...
## Knowledge Gaps
- **260 isolated node(s):** `Props`, `CoreMessage`, `ModelEntry`, `MODELS`, `ClassifiedError` (+255 more)
...
- **What connects `Props`, `CoreMessage`, `ModelEntry` to the rest of the system?**
