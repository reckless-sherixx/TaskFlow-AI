...
## Corpus Check
- 53 files · ~12,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 524 nodes · 778 edges · 42 communities (36 shown, 6 thin omitted)
...
## Knowledge Gaps
- **251 isolated node(s):** `redis`, `geistSans`, `geistMono`, `metadata`, `$schema` (+246 more)
...
- **What connects `redis`, `geistSans`, `geistMono` to the rest of the system?**
