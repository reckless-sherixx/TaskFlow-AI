...
## Corpus Check
- 37 files · ~9,422 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 289 nodes · 498 edges · 19 communities (14 shown, 5 thin omitted)
...
9. `SidebarMenuButton()` - 5 edges
10. `TooltipContent()` - 5 edges
...
Cohesion: 0.07
Nodes (19): ComposerAddAttachment(), ComposerAttachments(), UserMessageAttachments(), CodeHeader(), defaultComponents, MarkdownText, useCopyToClipboard(), Reasoning (+11 more)
...
Cohesion: 0.29
Nodes (8): message(), open(), resetIdleTimer(), runAI(), Session, sessions, sleep(), startIdleTimer()
