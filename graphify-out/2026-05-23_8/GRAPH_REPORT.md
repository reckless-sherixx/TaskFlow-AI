...
## Corpus Check
- 49 files · ~11,310 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 500 nodes · 735 edges · 32 communities (26 shown, 6 thin omitted)
...
Cohesion: 0.05
Nodes (37): dependencies, ai, @ai-sdk/google, @ai-sdk/openai, @assistant-ui/react, @assistant-ui/react-ai-sdk, @assistant-ui/react-markdown, class-variance-authority (+29 more)
...
Cohesion: 0.06
Nodes (36): error_message, input_preview, input_tokens, latency_ms, message_id, output_preview, output_tokens, name (+28 more)
...
Cohesion: 0.07
Nodes (27): model, provider, status, title, updated_at, name, notNull, primaryKey (+19 more)
...
Cohesion: 0.15
Nodes (9): db, queryClient, insertInferenceLog(), conversations, inferenceLogs, messages, IngestPayload, IngestPayloadSchema (+1 more)
