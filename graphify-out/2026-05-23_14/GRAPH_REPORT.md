...
## Corpus Check
- 54 files · ~12,905 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 534 nodes · 809 edges · 38 communities (33 shown, 5 thin omitted)
...
Cohesion: 0.05
Nodes (36): CodeHeader(), defaultComponents, MarkdownText, useCopyToClipboard(), Reasoning, ReasoningContent(), ReasoningFade(), ReasoningGroup (+28 more)

### Community 2 - "Package Dependencies"
Cohesion: 0.07
Nodes (30): geistMono, geistSans, metadata, AttachmentPreview(), AttachmentPreviewDialog(), AttachmentPreviewProps, AttachmentThumb(), AttachmentUI() (+22 more)
...
Cohesion: 0.12
Nodes (30): buildContextWindow(), estimateTokens(), warnIfOverBudget(), createConversation(), insertMessage(), updateConversationStatus(), updateConversationTitle(), fireLog() (+22 more)
...
Cohesion: 0.33
Nodes (6): error_message, name, notNull, primaryKey, type, columns
...
- **Why does `cn()` connect `UI Components (Sidebar)` to `UI Components (Dialog)`, `Package Dependencies`, `Package Scripts`?**
