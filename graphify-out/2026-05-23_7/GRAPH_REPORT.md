...
## Corpus Check
- 48 files · ~11,140 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 495 nodes · 727 edges · 32 communities (26 shown, 6 thin omitted)
...
Cohesion: 0.09
Nodes (22): devDependencies, @biomejs/biome, concurrently, drizzle-kit, tailwindcss, @tailwindcss/postcss, @types/node, @types/pg (+14 more)
...
Cohesion: 0.05
Nodes (41): error_message, input_preview, input_tokens, latency_ms, message_id, model, output_preview, output_tokens (+33 more)
...
Cohesion: 0.05
Nodes (38): created_at, provider, status, title, updated_at, default, name, notNull (+30 more)
...
Cohesion: 0.22
Nodes (5): db, queryClient, conversations, inferenceLogs, messages
