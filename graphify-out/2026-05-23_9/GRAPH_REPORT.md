...
## Corpus Check
- 51 files · ~11,565 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 511 nodes · 755 edges · 42 communities (36 shown, 6 thin omitted)
...
Cohesion: 0.12
Nodes (17): db, queryClient, createConversation(), insertInferenceLog(), insertMessage(), conversations, inferenceLogs, messages (+9 more)
