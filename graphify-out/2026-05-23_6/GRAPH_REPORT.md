...
## Corpus Check
- 41 files · ~10,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 314 nodes · 537 edges · 26 communities (20 shown, 6 thin omitted)
...
- **Why does `cn()` connect `UI Components (Sidebar)` to `UI Components (Dialog)`, `Package Dependencies`, `Tailwind & Aliases`, `Package Scripts`, `Reasoning Components`, `Community 22`, `Community 23`, `Community 24`, `Community 25`?**
